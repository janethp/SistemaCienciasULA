...
$consulta= "UPDATE estudiantes SET cedula='$cedula', pri_nom='$nom', seg_nom='$snom', pri_ape='$ape',seg_ape='$sape',sexo='$sexo',id_carrera='$carrera'
WHERE cedula='$cedula'";
...
<form action="consultaconsulta.php" method="post">
