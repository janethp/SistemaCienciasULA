...
<form action="tiempo2.php" method="post" onsubmit="return validacion()">
<center>
<table border="0"  >
	<tr>
	<h1> Asignar Maquina</h1>
	</tr>
	<tr>
	<td>Cedula </td>
	...
	<tr>
	<td>Maquina</td><td>  <select name="codmaquina" id="cedula"onchange="salta(this.form)" size="1" style="width:186px">
	<option></option>
	<?php
...
?>
	...
	<tr>
	<td>Fecha</td><td> <input type ="text" name="fecha" value="<?php echo $fecha ?>" ></td>
	</tr>
	<tr>
	<td> Hora</td><td>   <input type ="text" name="hora" value="<?php echo $hora ?>" > </td>
	</tr>
</table>
