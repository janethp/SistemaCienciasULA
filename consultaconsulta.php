...
<br>
 ...
 <center> <b><h3> Consulta de Usuario </h3></b> </center>
 <br>
<center>
<form action="consulta.php" onsubmit="return validacion()">
Ingrese el número de cédula <input type="text" name="cedula" size="10" id="cedula" value="V"/> 
<br>
				<br>
